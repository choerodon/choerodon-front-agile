    ...
    return (
      <React.Fragment>
        ...
        <span
          ...
          onClick={(e) => {
            e.stopPropagation();
            BoardStore.setClickedIssue(parentIssue);
          }}
        >
          {`#${issueNum}`}
        </span>
        ...
        <span
          ...
          style={JSON.stringify(BoardStore.getClickIssueDetail) !== '{}' ? {
            overflow: 'hidden',
            whiteSpace: 'nowrap',
          ...
          {this.renderByMode(mode, subIssueDataLength)}
          {
            mode === 'parent_child' ? (
              <Button
                ...
                onClick={(e) => {
                  e.stopPropagation();
                  BoardStore.setUpdateParent(parentIssue);
                  BoardStore.setTransFromData(parentIssue, parentIssue.issueId);
                }}
              >
                {'移动到done'}
              </Button>
