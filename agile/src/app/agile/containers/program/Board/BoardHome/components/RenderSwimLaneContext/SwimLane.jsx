...
class SwimLane extends Component {
  renderEpicLane = mode => (
    <EpicRenderHeader
      parentIssueArr={BoardStore.getInterconnectedData}
      otherIssueWithoutParent={BoardStore.getOtherQuestion}
      mode={mode}
      fromEpic
    >
  ...
  renderParentWithSub = (mode, fromEpic = null, parentIssue = null, epicPrefix = null) => (
    <RenderSwimLaneContext
      parentIssueArr={fromEpic ? parentIssue.interConnectedDataMap : BoardStore.getInterconnectedData}
      otherIssueWithoutParent={fromEpic ? parentIssue.unInterConnectedDataMap : BoardStore.getOtherQuestion}
      fromEpic={fromEpic}
