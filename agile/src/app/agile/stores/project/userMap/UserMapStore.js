...
class UserMapStore {
  ...
  loadEpic = () =>
    axios
      .get(`/agile/v1/projects/${AppState.currentMenuType.id}/issues/storymap/epics`)
      .then((epics) => {
        this.setEpics(epics);
      });

  loadFilters = () =>
    axios.get(`/agile/v1/projects/${AppState.currentMenuType.id}/quick_filter`).then((filters) => {
      this.setFilters(filters);
    });
  loadIssues = (type, pageType) =>
    axios
      .get(
        `/agile/v1/projects/${
  ...
  loadSprints = (data = []) =>
    axios
      .post(`/agile/v1/projects/${AppState.currentMenuType.id}/sprint/names`, data)
      .then((sprints) => {
