...
class BurndownChartStore {
  ...
  axiosGetBurndownChartReport(id, type, dateSort) {
    return axios.get(`/agile/v1/projects/${AppState.currentMenuType.id}/reports/${id}/burn_down_report?type=${type}&ordinalType=${dateSort}`);
  }
}
